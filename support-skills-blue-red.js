 ...
 * 参照ファイル：特能 (6).xlsx - 青赤サポートスキル.csv
 */
const SUPPORT_SKILLS_BLUE_RED = [
  {
    ...
    "effect": "自身の物理攻撃倍率を10％アップ。さらに魔法攻撃倍率を10％アップ。ただし命中率が10％ダウン。",
    "condition": "なし"
  },
  {
    "name": "がむしゃら",
    ...
    "effect": "自身の物理攻撃倍率を7％アップ。さらに魔法攻撃耐性を7％アップ。ただし自身の物理攻撃耐性を2％ダウン、魔法攻撃耐性を2％ダウン。",
    "condition": "なし"
  },
  {
    "name": "ヒーラー魂",
    ...
    "effect": "自身のHP回復効果倍率を3％アップ。ただし自身の物理攻撃耐性を1％ダウン。",
    "condition": "なし"
  }
];
